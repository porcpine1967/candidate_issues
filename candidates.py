CANDIDATES = (
    ...
    ('biden2', None, None, 'div', ('class', 'entry-content',), 'unmatched', ('https://joebiden.com/justice/',),),
    ('biden3', None, None, 'div', ('class', 'entry-content',), False, ('https://joebiden.com/healthcare/',
    ...
    ('castro2', 'nav', None, 'section', None, 'not nested', ('https://issues.juliancastro.com/people-first-immigration/',
    ...
    ('deblasio', 'ul', ('class', 'header__nav--list',), 'article', None, False, ('https://billdeblasio.com/policies',
    ...
    ('delaney2', None, None, 'main', ('class', 'entry-content',), 'not nested', ('https://www.johndelaney.com/issues/infrastructure/',
    ...
    ('gabbard', 'div', ('class', 'main-menus',), 'nav', ('id', 'block-record',), False, ('https://www.tulsi2020.com/record',),),
    ('gabbard2', None, None, 'article', ('class', 's-article',), False, ('https://www.tulsi2020.com/record/foreign-policy-prosperity-through-peace',
    ...
    ('orourke', 'nav', ('class', 'header__nav',), 'article', None, 'nested', ('https://betoorourke.com/kickoff-remarks/',
    ...
    ('ryan', 'nav', None, 'div', ('class', 'container_inner',), False, ('https://timryanforamerica.com/issues/',),),
    ('ryan2', None, None, 'div', ('class', 'content',), False, ('https://timryanforamerica.com/industrialplan/',
                                                                ...
                                                                'https://timryanforamerica.com/agriculture-food-system/',
                                                                'https://timryanforamerica.com/veterans/',
                                                                ),),
    ('sanders', 'nav', ('id', 'menu-main-header',), 'article', None, False, ('https://berniesanders.com/issues/',),),
    ('sanders2', None, None, 'article', None, 'nested', ('https://berniesanders.com/issues/health-care-for-all/',
    ...
    ('yang2', None, None, 'div', ('class', 'entry-content',), False, ('https://www.yang2020.com/policies/12-year-congressional-term-limits/',
