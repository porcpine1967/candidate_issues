CANDIDATES = (
    ...
    ('castro2', 'nav', None, 'section', None, -1, ('https://issues.juliancastro.com/people-first-immigration/',
    ...
    ('delaney2', None, None, 'main', ('class', 'entry-content',), -1, ('https://www.johndelaney.com/issues/infrastructure/',
    ...
    ('orourke', 'nav', ('class', 'header__nav',), 'article', None, 1, ('https://betoorourke.com/kickoff-remarks/',
    ...
    ('sanders2', None, None, 'article', None, 1, ('https://berniesanders.com/issues/health-care-for-all/',
    ...
    ('swalwell', 'div', ('class', 'site-nav',), 'div', ('class', 'content-wrap'), -1, ('https://ericswalwell.com/my-plan/',),),
    ('warren', 'nav', ('id', 'js-takeover-menu',), 'section', ('class', 'issues-lp__accordion'), 1, ('https://elizabethwarren.com/issues',),),
    ('williamson', 'nav', None, 'div', ('class', 'issues',), False, ('https://www.marianne2020.com/issues',),),
    ('williamson2', None, None, 'div', ('class', 'issues-section',), -1, ('https://www.marianne2020.com/issues/child-advocacy',
